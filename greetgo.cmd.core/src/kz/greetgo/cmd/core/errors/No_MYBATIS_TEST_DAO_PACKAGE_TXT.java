...
public class No_MYBATIS_TEST_DAO_PACKAGE_TXT extends NoGreetgoParamFile {
  public No_MYBATIS_TEST_DAO_PACKAGE_TXT(Path greetgoParamFile) {
  ...
  private static String text() {
    return "" +
      "#\n" +
      "#  This parameter file defines a location of package for test dao interface.\n" +
      "#  \n" +
      ...
      "#  " + IGNORING_LINES + "\n" +
      "#\n" +
      "sandbox.register/test_src     kz/greetgo/sandbox/register/test/dao";
  }
}
