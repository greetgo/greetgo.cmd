...
public class No_REGISTER_INTERFACE_PACKAGE_TXT extends NoGreetgoParamFile {
  public No_REGISTER_INTERFACE_PACKAGE_TXT(Path greetgoParamFile) {
  ...
  private static String text() {
    return "" +
      "#\n" +
      "#  This parameter file defines a location of register interface file.\n" +
      "#  \n" +
