...
public class No_REGISTER_IMPL_PACKAGE_TXT extends NoGreetgoParamFile {
  public No_REGISTER_IMPL_PACKAGE_TXT(Path greetgoParamFile) {
  ...
  private static String text() {
    return "" +
      "#\n" +
      "#  This parameter file defines a location of register impl class file.\n" +
      "#  \n" +
      ...
      "#  " + IGNORING_LINES + "\n" +
      "#\n" +
      "sandbox.register/src    kz/greetgo/sandbox/register/impl";
  }
}
